...
(function () {
    ...
    if (h && p && D) {
      ...
      if (!u)
        try {
          ...
          (p = window.open()),
            p.document.write(
              "<img src='" + h + "'></img><div>Please right click on the image and save it to your device</div>"
            ),
            p.document.close();
        }
    }
  ...
  function hb(h) {
    if (!ib) {
      ...
      'undefined' === typeof ra.Chart.creditHref
        ...
        : ((p = h.updateOption('creditText')), (D = h.updateOption('creditHref')));
      ...
      : this.parent &&
        ...
        (null === r
          ...
          : 0 < this.parent.themeOptions[p].length &&
            ((r = Math.min(this.parent.themeOptions[p].length - 1, r)), (h = this.parent.themeOptions[p][r])));
    this.themeOptions = h;
  ...
  var Ja = !1,
    ...
    Ba = {
      colorSet1: '#4F81BC #9BBB58 #C0504E #23BFAA #8064A1 #4AACC5 #F79647 #7F6084 #77A033 #33558B #E59566'.split(' '),
  ...
  var $a = {},
    ...
    Ra = function (h) {
      ...
      h.offsetX || 0 === h.offsetX
        ...
        : ((p = h.pageX - h.target.offsetLeft), (r = h.pageY - h.target.offsetTop));
      return { x: p, y: r };
    },
    bb = !0,
  ...
  V.prototype.set = function (h, p, r) {
    ...
    if ('options' === h) this.createUserOptions(p);
      ...
      u.hasOwnProperty(h) ||
      (u.publicProperties && u.publicProperties.hasOwnProperty(h) && 'readWrite' === u.publicProperties[h])
    )
  ...
  V.prototype.addTo = function (h, p, r, u) {
    ...
    v.hasOwnProperty(h) ||
    (v.publicProperties && v.publicProperties.hasOwnProperty(h) && 'readWrite' === v.publicProperties[h])
  ...
  Na.Chart = (function () {
    ...
    function E(a, d, b, c, e, g, k, l, w, m) {
      ...
      w && 0 < k.thickness
        ...
        : 0 < k.thickness && (a.moveTo(d, b + s), a.lineTo(c, b + s), a.moveTo(d, e - s), a.lineTo(c, e - s));
      a.stroke();
      a.restore();
    }
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (
          ...
          a.axisY.scaleBreaks &&
            ...
            (d.dataPointYPositiveSums
              ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, k),
        ...
        for (n in l)
          l.hasOwnProperty(n) &&
            ...
            n < b.viewPortMin ||
              n > b.viewPortMax ||
              (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, m))));
      }
    };
    p.prototype._processStacked100PlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (
          var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g = !1, k = !1, l = !1, w = [], m = 0;
    ...
    p.prototype._processMultiYPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (
          var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g, k, l = !1, w = 0;
          ...
          for (s = 0; s < m.dataPoints.length; s++) {
            ...
            if (!(c < r) || q) {
              ...
              null === e
                ...
                : (g < d.viewPortMin && (d.viewPortMin = g), k > d.viewPortMax && (d.viewPortMax = k));
            }
          }
    ...
    p.prototype.calculateAutoBreaks = function () {
              ...
              if (!(4 > h.dataPoints.length))
                for (w = 0; w < h.dataPoints.length; w++)
                  if (
                    (c &&
                      ((q =
                        ((l + 1 - m) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10)) / 100),
                    ...
                    var r =
                      ((n + 1 - k) * Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) || 10, 10)) / 100;
                    if ((g = 'waterfall' === a.type ? h.dataPointEOs[w].cumulativeSum : h.dataPoints[w].y) && g.length)
                      ...
                      u(g) ||
                        ((q = Math.floor((g - k) / r)), g < d[q].min && (d[q].min = g), g > d[q].max && (d[q].max = g));
                  }
            }
        }
      }
      function b(a) {
        if (
          ...
          for (
            var c = a.axisX.dataInfo, b = c.min, d = c.max, f = c._dataRanges, g, m = 0, l = 0;
          ...
          if (this._axes[k].dataInfo._dataRanges) {
            ...
            c =
              ((this._axes[k].dataInfo.max + 1 - w) *
                Math.max(parseFloat(this._axes[k].scaleBreaks.collapsibleThreshold) || 10, 10)) /
              100;
            ...
            if (this._axes[k].scaleBreaks.customBreaks)
              for (l = 0; l < this._axes[k].scaleBreaks.customBreaks.length; l++)
                for (c = 0; c < g.length; c++)
                  if (
                    (this._axes[k].scaleBreaks.customBreaks[l].startValue <= g[c].start &&
                      g[c].start <= this._axes[k].scaleBreaks.customBreaks[l].endValue) ||
                    (this._axes[k].scaleBreaks.customBreaks[l].startValue <= g[c].start &&
                      g[c].start <= this._axes[k].scaleBreaks.customBreaks[l].endValue) ||
                    (g[c].start <= this._axes[k].scaleBreaks.customBreaks[l].startValue &&
                      this._axes[k].scaleBreaks.customBreaks[l].startValue <= g[c].end) ||
                    (g[c].start <= this._axes[k].scaleBreaks.customBreaks[l].endValue &&
                      this._axes[k].scaleBreaks.customBreaks[l].endValue <= g[c].end)
                  )
                    g.splice(c, 1), c--;
            g.sort(function (a, c) {
            ...
            for (l = 0; l < Math.min(g.length, this._axes[k].scaleBreaks.maxNumberOfAutoBreaks); l++)
              (c = a(
                ...
                this._axes[k].scaleBreaks.autoBreaks.push(
                  new L(this, 'autoBreaks', c, l, ++this._eventManager.lastObjectId, this._axes[k].scaleBreaks)
                ),
                this._axes[k].scaleBreaks._appliedBreaks.push(
                  this._axes[k].scaleBreaks.autoBreaks[this._axes[k].scaleBreaks.autoBreaks.length - 1]
                );
        ...
        if (null !== x && '' !== x) {
          ...
          if ('normal' === this.plotInfo.axisPlacement) {
            ...
            'inside' !== t
              ? ((e = b.y1),
                ...
                0 < ma
                  ? ((n = m.point.y - w - k - c),
                    n < e && ((n = 'auto' === t ? Math.max(m.point.y, e) + k + c : e + k + c), (v = n + w > m.point.y)))
                  : ((n = m.point.y + k + c),
                    n > g - w - k - c &&
                      ((n = 'auto' === t ? Math.min(m.point.y, g) - w - k - c : g - w - k - c), (v = n < m.point.y))))
              : ((e = Math.max(m.bounds.y1, b.y1)),
                ...
                0 < ma
                  ? ((n = Math.max(m.point.y, c) - w / 2),
                    n < e && ('bubble' === s || 'scatter' === s) && (n = Math.max(m.point.y - w - k, b.y1 + k)))
              ...
              'inside' !== t
                ? ((k = b.x1),
                  ...
                  0 > ma
                    ? ((q = m.point.x - l - e - c),
                      q < k &&
                        ((q = 'auto' === t ? Math.max(m.point.x, k) + e + c : k + e + c), (v = q + l > m.point.x)))
                    : ((q = m.point.x + e + c),
                      q > g - l - e - c &&
                        ((q = 'auto' === t ? Math.min(m.point.x, g) - l - e - c : g - l - e - c), (v = q < m.point.x))))
          ...
          p &&
            ...
            ((0 > s.indexOf('bar') && ('error' !== s || !m.axisSwapped) && m.point.x > b.x1 && m.point.x < b.x2) ||
              !v) &&
            ((0 > s.indexOf('column') && ('error' !== s || m.axisSwapped) && m.point.y > b.y1 && m.point.y < b.y2) ||
              !v) &&
            ((d.lineWidth = p),
                    ...
                    ? (!p && m.connectNullData
                        ? (b.setLineDash &&
                            (m.options.nullDataLineDashType ||
                              (q === m.lineDashType && m.lineDashType !== m.nullDataLineDashType)) &&
                            (b.stroke(),
                            b.beginPath(),
                            b.moveTo(k.x, k.y),
                ...
                if ('number' !== typeof s[p].y)
                  0 < p &&
                    ...
                    (m.connectNullData
                      ? c.setLineDash &&
                        0 < x.length &&
                        (m.options.nullDataLineDashType || !s[p - 1].lineDashType) &&
          ...
          if (0 < B.length)
            for (var p = 5 < q && f.bevelEnabled ? !0 : !1, g = 0; g < B.length; g++)
              if (
                ...
                k = a.axisX.reversed
                  ? (k + (a.plotType.totalDataSeries * q) / 2 - (a.previousDataSeriesCount + s) * q) << 0
                  : (k - (a.plotType.totalDataSeries * q) / 2 + (a.previousDataSeriesCount + s) * q) << 0;
    ...
    p.prototype.renderStackedColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        this.dataPointMaxWidth &&
          m > s &&
          (m = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, s));
        !this.dataPointMaxWidth &&
          this.dataPointMinWidth &&
          s < m &&
          (s = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, m));
        f < m && (f = m);
        f > s && (f = s);
        b.save();
        r && this._eventManager.ghostCtx.save();
          ...
          if (0 < t.length) {
            ...
            for (m = 0; m < t.length; m++)
              if (
                ...
                if (
                  a.axisY.logarithmic ||
                  (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[m].y)
                )
                  (l[c] = t[m].y + (l[c] ? l[c] : 0)),
                    0 < l[c] &&
                ...
                'number' !== typeof h[p].y
                  ...
                  : ((t = a.axisX.convertValueToPixel(x)),
                    ...
                    p < h.length - 1 &&
                      ...
                      g.setLineDash &&
                        (h[p].lineDashType
                          ? ((Y = h[p].lineDashType), g.setLineDash(R(Y, B.lineThickness)))
              ...
              if (
                ...
                if ('number' !== typeof Z.y) A.connectNullData || da || C || d(), (da = !0);
                  ...
                  C || da
                    ...
                    : (c.lineTo(f, h),
                      r && u.lineTo(f, h),
                      0 == n % 250 && (d(), c.moveTo(f, h), r && u.moveTo(f, h), m.push({ x: f, y: p - oa })));
                  t = { x: f, y: h };
                  n < z.length - 1 &&
              ...
              if (
                ...
                if ('number' !== typeof Z.y) A.connectNullData || da || u || d(), (da = !0);
                  ...
                  u || da
                    ...
                    : (c.lineTo(f, h),
                      r && x.lineTo(f, h),
                      0 == n % 250 && (d(), c.moveTo(f, h), r && x.moveTo(f, h), m.push({ x: f, y: C - la })));
                  p = { x: f, y: h };
                  n < z.length - 1 &&
    ...
    p.prototype.renderBubble = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var h = 25 * Math.PI, p = Math.max(Math.pow((0.25 * Math.min(c.height, c.width)) / 2, 2) * Math.PI, h), m = 0;
          m < a.dataSeriesIndexes.length;
          m++
        )
          ...
          if (0 < s.length) {
            ...
            for (var q = 0, n = 0, e = 0; e < s.length; e++)
              if (
                ...
                b.globalAlpha = 1;
                (Math.sqrt((q - g) * (q - g) + (n - k) * (n - k)) < Math.min(f.size, 5) &&
    ...
    p.prototype.renderRangeColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        this.dataPointMaxWidth &&
          g > k &&
          (g = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, k));
        !this.dataPointMaxWidth &&
          this.dataPointMinWidth &&
          k < g &&
          (k = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, g));
        m < g && (m = g);
        m > k && (m = k);
        b.save();
        r && this._eventManager.ghostCtx.save();
            ...
            for (var h = 5 < m && n.bevelEnabled ? !0 : !1, g = 0; g < f.length; g++)
              if (
                ...
                var p = a.axisX.reversed
                    ? (c + (a.plotType.totalDataSeries * m) / 2 - (a.previousDataSeriesCount + s) * m) << 0
                    : (c - (a.plotType.totalDataSeries * m) / 2 + (a.previousDataSeriesCount + s) * m) << 0,
                ...
                if (
                  ...
                  q < h.length - 1 &&
                    ...
                    c.setLineDash &&
                      (h[q].lineDashType
                        ...
                        : ((F = m.lineDashType), (u[u.length - 1].newLineDashArray = y))));
                  ...
                  0 < q &&
                    ...
                    (m.connectNullData
                      ? c.setLineDash &&
                        0 < u.length &&
                        (m.options.nullDataLineDashType || !h[q - 1].lineDashType) &&
                        ((u[u.length - 1].newLineDashArray = A), (F = m.nullDataLineDashType))
                      : (d(y, C), (u = []), (z = []))),
                    (f = !0);
            d(y, C);
            ia.drawMarkers(g);
    ...
    p.prototype.renderWaterfall = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        this.dataPointMaxWidth &&
          k > h &&
          (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, h));
        !this.dataPointMaxWidth &&
          this.dataPointMinWidth &&
          h < k &&
          (h = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, k));
        n < k && (n = k);
        n > h && (n = h);
        b.save();
        r && this._eventManager.ghostCtx.save();
              ...
              if ((v[k].getTime ? (s = v[k].x.getTime()) : (s = v[k].x), 'number' !== typeof v[k].y)) {
                ...
                h =
                  0 === u.dataPointEOs[k].cumulativeSum
                    ? q
                    : a.axisY.convertValueToPixel(u.dataPointEOs[k].cumulativeSum);
                m =
                  0 === u.dataPointEOs[k].cumulativeSumYStartValue
                    ? q
                    : a.axisY.convertValueToPixel(u.dataPointEOs[k].cumulativeSumYStartValue);
                l = a.axisX.reversed
                ...
                var Y,
                  T = l;
                Y =
                  ('undefined' !== typeof v[k].isIntermediateSum && !0 === v[k].isIntermediateSum) ||
                  ('undefined' !== typeof v[k].isCumulativeSum && !0 === v[k].isCumulativeSum)
                    ? 0 < v[k].y
                      ? h
                      : m
                    : 0 < v[k].y
          ...
          for (d = 0; d < s.length; d++)
            (k = f[(c + d) % s.length]),
              1 < a &&
                ...
                k.midAngle < Math.PI / 2 + t &&
                (g <= a / 2 && !q ? ((k.hemisphere = 'right'), g++) : ((k.hemisphere = 'left'), (q = !0)));
          q = !1;
          for (d = 0; d < s.length; d++)
            (k = f[(e + d) % s.length]),
              1 < b &&
                ...
                k.midAngle < (3 * Math.PI) / 2 + t &&
                (l <= b / 2 && !q ? ((k.hemisphere = 'left'), l++) : ((k.hemisphere = 'right'), (q = !0)));
        }
      }
      function b(a) {
        ...
        for (b = 0; b < s.length; b++) {
          ...
          if (e > c) {
            ...
            if (s[b].exploded) {
              ...
              (f[b].center.x = x.x + d * (1 - a)), (f[b].center.y = x.y + g * (1 - a)), (k = !0);
            k &&
              ((d = {}),
              (d.dataSeries = m),
            ...
            ? ((l = 'right' === n.hemisphere ? q : h),
              ...
              null !== l &&
                ...
                b - q < p &&
                  ((m = -q),
                  (l = g(l, m, d + 1)),
                  +l.toFixed(C) > +m.toFixed(C) && (k = b > p ? -(b - p) : -(q - (l - m))))))
            : 0 < b &&
              ...
              null !== l &&
                ...
                b - q < p &&
                  ((m = q), (l = g(l, m, d + 1)), +l.toFixed(C) < +m.toFixed(C) && (k = b > p ? b - p : q - (m - l)))));
          k &&
              ...
              if (((g = !1), (t = f[l]), t.indexLabelText)) {
                ...
                if (null !== k) {
                  ...
                  if ((n = 0 > z)) {
                    ...
                    n =
                      t.indexLabelTextBlock.x + t.indexLabelTextBlock.width < m.indexLabelTextBlock.x - q ||
                      n > u + q ||
                      h > r + q ||
                      w < p - q
                        ? !1
      ...
      function l() {
        ...
        h.legend &&
          (h.legend.dockInsidePlotArea ||
            ('center' === h.legend.horizontalAlign && 'center' === h.legend.verticalAlign)) &&
          ...
          this._animator.animate(
            ...
            function (a) {
              ...
              for (b = 0; b < s.length; b++) {
                ...
                e > c &&
                  ja(h.plotArea.ctx, f[b].center, f[b].radius, g, m.type, c, e, m.fillOpacity, f[b].percentInnerRadius);
                if (d) break;
              }
              l();
            },
        ...
        if (d)
          for (k = J.length - 1; 0 <= k; k--)
            (a = P[k]),
              ...
              t.reversed
                ? (J[k].textBlock.y + J[k].height > pa + D && (J[k].textBlock.y = pa + D - J[k].height),
    ...
    H.prototype.setLayout = function () {
      ...
      'top' === this.verticalAlign || 'bottom' === this.verticalAlign
        ? ((this.orientation = 'horizontal'),
          ...
          (k = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height))
        : 'center' === this.verticalAlign &&
            ...
            for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++)
              if (!this._labels[b].breaksLabelType) {
                ...
                c =
                  ...
                  (k - a.fontSize / 2) * Math.cos((Math.PI / 180) * Math.abs(this.labelAngle));
                if (u(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                  if (
                    ...
                    (p =
                      (m - (h + a.fontSize / 2) * Math.cos((Math.PI / 180) * Math.abs(-25))) /
                  ...
                  (p =
                    0 != this.labelAngle
                      ? (m - (h + a.fontSize / 2) * Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))) /
                        Math.sin((Math.PI / 180) * Math.abs(this.labelAngle))
                      : g),
                  (this.sessionVariables.labelMaxHeight = k = this.labelWrap
                    ? (m - p * Math.sin((Math.PI / 180) * Math.abs(this.labelAngle))) /
                      Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))
                    : 1.5 * this.labelFontSize),
                  u(this.options.labelWrap))
                    ? u(this.options.labelWrap) &&
                  ...
                  : ((this.sessionVariables.labelAngle = this.labelAngle),
                    (this.sessionVariables.labelMaxWidth =
                      0 === this.labelAngle
                        ? g
                        : Math.min(
                            (c - k * Math.sin((Math.PI / 180) * Math.abs(this.labelAngle))) /
                              Math.cos((Math.PI / 180) * Math.abs(this.labelAngle)),
                            k
                          )),
                    u(this.options.labelWrap))
                ...
                !a[f] ||
                  ...
                  0 < a[f].labelAngle
                    ...
                    ? A - z < k &&
                      ...
                      (F = k - (K + a[f].tickLength + D + A - z + a[f].labelFontSize / 2))
                    : 0 === a[f].labelAngle &&
                      (E + t > h && (l = E + t / 2 - h - ba),
            ...
            for (f = 0; f < a.length; f++)
              a[f] &&
                ...
                a[f]._labels &&
                  ...
                  (E = a[f].logarithmic
                    ? (1 < k
                        ? (Math.log(k) / a[f].conversionParameters.lnLogarithmBase) *
                          Math.abs(a[f].conversionParameters.pixelPerUnit)
            ...
            for (f = 0; f < d.length; f++)
              d[f].calculateValueToPixelConversionParameters(),
                ...
                d[f]._labels &&
                  ...
                  (E = d[f].logarithmic
                    ? (1 < k
                        ? (Math.log(k) / d[f].conversionParameters.lnLogarithmBase) *
                          Math.abs(d[f].conversionParameters.pixelPerUnit)
            ...
            for (f = 0; f < b.length; f++)
              (b[f].lineCoordinates = {}),
                ...
                b[f].labelAutoFit &&
                  !u(C) &&
                  (0 < !a.length &&
                    (k = 0 > b[f].labelAngle ? Math.max(k, C) : 0 === b[f].labelAngle ? Math.max(k, C / 2) : k),
            ...
            for (f = 0; f < c.length; f++)
              (c[f].lineCoordinates = {}),
                ...
                c[f] &&
                  ...
                  !u(D) &&
                  (0 < !a.length &&
                    (k = 0 < c[f].labelAngle ? Math.max(k, D) : 0 === c[f].labelAngle ? Math.max(k, D / 2) : k),
                  0 < !d.length && (h -= y / 2)),
            ...
            for (f = 0; f < a.length; f++) {
              ...
              if (b && 0 < b.length)
                for (K = 0; K < b.length; K++)
                  b[K] &&
                    b[K].labelAutoFit &&
                    ((h = 0 > b[K].labelAngle ? Math.max(h, C) : 0 === b[K].labelAngle ? Math.max(h, C / 2) : h),
    ...
    z.prototype.renderStripLinesOfThicknessType = function (a) {
      if (this.stripLines && 0 < this.stripLines.length && a) {
        for (
          var d = this, b, c = 0, e = 0, g = !1, k = !1, l = [], h = [], k = !1, c = 0;
          ...
          m._thicknessType === a &&
            (('pixel' === a &&
              (m.value < this.viewportMinimum || m.value > this.viewportMaximum || u(m.value) || isNaN(this.range))) ||
              l.push(m));
        }
    ...
    z.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      if (this.scaleBreaks)
        for (k = 0; k < this.scaleBreaks._appliedBreaks.length; k++)
          if (
            ((!u(this.sessionVariables.newViewportMinimum) &&
              this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[k].startValue) ||
            ...
            ((!u(this.sessionVariables.newViewportMaximum) &&
              this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[k].endValue) ||
      ...
      'axisX' === this.type
        ...
        : 'axisY' === this.type &&
          ...
          1 === c && 1 === e
            ...
            : 1 === e / c
            ? ((k = Math.min(e * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5))),
              (e *= k),
              (c /= k))
            : c > e
            ? ((k = Math.min((c / e) * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5))),
              1 <= e ? (c = e / k) : (e = c * k))
      ...
      this.options && 0 < this.options.interval
        ...
        : ((this.interval = z.getNiceExponent(Math.log(k) / d / (a - 1), !0)), (b = z.getNiceNumber(l / (a - 1), !0)));
      if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
      ...
      1 === this.viewportMaximum &&
        ...
        this.options &&
          'undefined' === typeof this.options.interval &&
          ((this.interval = z.getNiceExponent(Math.ceil(Math.log(k) / d) / (a - 1))),
      ...
      if (this.snapToDataPoint) {
        ...
        if ('xySwapped' === this.chart.plotInfo.axisPlacement) {
          ...
          if ('rangeBar' === k[0].dataSeries.type || 'error' === k[0].dataSeries.type)
            for (
              var f = Math.abs(a - this.parent.convertValueToPixel(k[r].dataPoint.y[0])), v = 0, n = 0;
              n < k.length;
              n++
            )
            ...
            for (
              var f = Math.abs(a - this.parent.convertValueToPixel(k[0].dataPoint.y)), D = (v = 0), n = (r = 0);
              n < k.length;
              n++
            )
              if (k[n].dataPoint.y && k[n].dataPoint.y.length)
            ...
            for (
              var f = Math.abs(a - this.parent.convertValueToPixel(k[0].dataPoint.y)), t = (D = v = 0), n = 0;
              n < k.length;
              n++
            )
              if (k[n].dataPoint.y && k[n].dataPoint.y.length)
          ...
          if (
            ...
            for (
              f = Math.abs(d - this.parent.convertValueToPixel(k[0].dataPoint.y)), n = t = D = v = 0;
              n < k.length;
              n++
            )
              if (k[n].dataPoint.y && k[n].dataPoint.y.length)
          ...
          if ('xySwapped' === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX)
              for (var h = 0; h < this.chart.axisX.length; h++) {
                for (
                  var k = this.chart.axisX[h].convertPixelToValue({ y: d }), m = null, c = 0;
                  c < this.chart.axisX[h].dataSeries.length;
                  c++
                )
                  (m = this.chart.axisX[h].dataSeries[c].getDataPointAtX(k, b)) &&
                    0 <= m.index &&
                    ((m.dataSeries = this.chart.axisX[h].dataSeries[c]), null !== m.dataPoint.y && l.push(m));
                m = null;
              }
            if (this.chart.axisX2)
              for (h = 0; h < this.chart.axisX2.length; h++) {
                ...
                for (c = 0; c < this.chart.axisX2[h].dataSeries.length; c++)
                  (m = this.chart.axisX2[h].dataSeries[c].getDataPointAtX(k, b)) &&
                    0 <= m.index &&
                    ((m.dataSeries = this.chart.axisX2[h].dataSeries[c]), null !== m.dataPoint.y && l.push(m));
                m = null;
              }
          } else {
            l = [];
            if (this.chart.axisX)
              for (h = 0; h < this.chart.axisX.length; h++)
                for (
                  k = this.chart.axisX[h].convertPixelToValue({ x: a }), m = null, c = 0;
                  c < this.chart.axisX[h].dataSeries.length;
                  c++
                )
                  (m = this.chart.axisX[h].dataSeries[c].getDataPointAtX(k, b)) &&
            ...
            if (this.chart.axisX2)
              for (h = 0; h < this.chart.axisX2.length; h++)
                for (
                  k = this.chart.axisX2[h].convertPixelToValue({ x: a }), m = null, c = 0;
          ...
          if (0 <= this.currentSeriesIndex) {
            ...
            if (0 <= this.currentDataPointIndex)
              (c = e.dataPoints[this.currentDataPointIndex]),
                ...
                'waterfall' === e.type &&
                  ((m.cumulativeSumYStartValue = e.dataPointEOs[this.currentDataPointIndex].cumulativeSumYStartValue),
          ...
          if ((this.highlightObjects(g), this.enabled))
            if (((b = ''), (b = this.getToolTipInnerHTML({ entries: g })), null !== b)) {
              ...
              'stackedBar100' === g[0].dataSeries.type
                ...
                : ((a =
                    (g[0].dataSeries.axisX.convertValueToPixel(g[0].dataPoint.x) - this.container.clientWidth) << 0),
                  (a -= 10));
